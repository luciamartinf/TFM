...
from utils import write_tsv, read_coverm_as_nested_dict, extract_orf_lengths
...
# Example: ./emapper_profiler.py --input_dir data_resume -k KEGG_pathway_dict.txt -e -u tpm -o results_tpm
